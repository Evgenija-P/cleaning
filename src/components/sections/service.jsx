...
const Service = () => {
  return (
    <section className="min-h-[1060px] bg-lightBlueSecond" id="services">
      <div className="container mx-auto py-[120px] relative">
        ...
        <ServicesList />
        <div className="w-[256px] h-[256px] rounded-full bg-lightBlue absolute top-[-70px] left-[-175px] blur-2xl" />
      </div>
    </section>
  );
};
